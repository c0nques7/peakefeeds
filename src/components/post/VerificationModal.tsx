...
export function VerificationModal({ isOpen, onClose, onVerified, contentHash }: VerificationModalProps) {
    ...
    // 🟢 1. FIX: Destructure 'startVerification' instead of 'triggerAdWaterfall'
    const { 
        startVerification, 
        selectAdFlow, 
        selectQuestFlow, 
    ...
    const handleWatchAd = async () => {
        try {
            ...
            // 🟢 FIX: Call startVerification here
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-in fade-in duration-200">
            ...
            <AdPlayerOverlay 
                ...
                onSelectVideo={selectAdFlow}   // 👈 Connect Video Handler
                onSelectQuest={selectQuestFlow} // 👈 Connect Quest Handler
                onCancel={() => {
                    resetAdState();
                }} 
            />
